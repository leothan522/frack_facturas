...
<div class="pr-3 pl-3">
    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <input @if($displayDetalles == "zelle") type="text" @else type="number" @endif wire:model="referenciaPago" class="form-control" placeholder="Referencia" id="input_referencia">
            <div class="input-group-append">
                <button type="button" class="input-group-text text-primary" onclick="pegarPortapapeles()">
                    Pegar
                </button>
            </div>
            @error('referenciaPago')
    ...
    <div class="form-group">
        ...
        <input type="date" wire:model="fechaPago" class="form-control" placeholder="Fecha">
        @error('fechaPago')
        <span class="col-sm-12 text-sm text-bold text-danger">
            <i class="icon fas fa-exclamation-triangle"></i>
            {{ $message }}
