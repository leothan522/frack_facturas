<button id="launch-modal-ver-factura" type="button" class="d-none" data-toggle="modal" data-target="#modal-ver-factura">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0" wire:loading.class="invisible" wire:target.except="btnVerPDF">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <span>Factura:</span>
                        <a href="#" target="_blank" class="float-right text-bold text-uppercase d-md-none" wire:click="btnVerPDF" onclick="verModalPDF()" data-toggle="modal" data-target="#modal-ver-pdf">{{ $facturaNumero }}</a>
