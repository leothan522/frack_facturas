<div class="mailbox-controls">
    ...
    <div class="btn-group btn-group-sm">
        <button type="button" class="btn btn-default" data-toggle="dropdown" aria-expanded="false">{{ $this->getOrganizacion($organizacionActual) }}</button>
        ...
        <div class="dropdown-menu" role="menu">
            @foreach($this->getOrganizacion() as $key => $value)
