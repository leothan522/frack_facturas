        ...
        <div class="modal-content {{--fondo--}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="@if($show) d-none @endif">
                        @include('dashboard.organizaciones.form')
                    </div>

                    <div class="@if(!$show) d-none @endif">
                        @include('dashboard.organizaciones.show')
                    </div>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    @else
                        <button type="button" class="btn btn-danger btn-sm" wire:click="destroy({{ $organizaciones_id }})">
                            <i class="fas fa-trash-alt"></i>
                        </button>
                        <button type="button" class="btn btn-primary btn-sm" wire:click="edit({{ $organizaciones_id }})">
